...
func TestLetStatements(t *testing.T) {
	t.Log("TestLetStatements() started")
...
`
	...
	for i, tt := range tests {
		...
		if !testLiteralExpression(t, val, tt.expectedInteger) {
			return
		}

	}

	t.Log("TestLetStatements() passed")
}

func TestReturnStatements(t *testing.T) {
	t.Log("TestReturnStatements() started")
...
`
	...
	t.Log("TestReturnStatements() passed")
}

func TestBooleanExpression(t *testing.T) {
	t.Log("TestBooleanExpression() started")
...
`
	...
	for i, tt := range tests {
		...
		testBooleanLiteral(t, boolean.Expression, tt.expectedValue)
	}

	t.Log("TestBooleanExpression() passed")
}
...
func TestIdentifierExpression(t *testing.T) {
	t.Log("TestIdentifierExpression() started")
	...
	t.Log("TestIdentifierExpression() passed")
}

func TestIntegerExpression(t *testing.T) {
	t.Log("TestIntegerExpression() started")
	...
	t.Log("TestIntegerExpression() passed")
}
...
func testBooleanLiteral(t *testing.T, b ast.Expression, value bool) bool {
	bool, ok := b.(*ast.Boolean)

	if !ok {
		t.Errorf("b is not ast.Boolean. got=%T", b)
		return false
	}

	if bool.Value != value {
		t.Errorf("bool.Value is not %t. got=%t", value, bool.Value)
		return false
	}

	if bool.TokenLiteral() != fmt.Sprintf("%t", value) {
		t.Errorf("bool.TokenLiteral is not %t. got=%s", value, bool.TokenLiteral())
		return false
	}
